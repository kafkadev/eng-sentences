...
<nav-list></nav-list>
    ...
    <div class="row">
        ...
        <div v-if="posts && showCat" class="col-md-4" style="height: calc(100vh - 160px);
    overflow-y: scroll;">


            <button
            v-for="(item, indexa) in _.keys(_.indexBy(categories, 'category'))" type="button" class="btn btn-outline-primary btn-sm"
             @click="searchTag = item, getArticle(item)" style="width:185px;margin:4px;float:left;font-weight:600;text-align:left;"
    ...
    <div class="table-responsive col-md-8"  style="height: calc(100vh - 160px);
    overflow-y: scroll;">
...
<div v-if="selectedPost && selectedPost.title" :class="[selectedPost ? 'showModal':'']" class="modal fade bd-example-modal-xl show" :aria-modal="(selectedPost.title)" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" :aria-hidden="(!selectedPost.title)" style="
">
